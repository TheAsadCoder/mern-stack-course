...
const Register = () => {
  ...
  return (
    <>
    <div className="max-w-3xl px-5 md:px-8 mt-10 mx-auto bg-[#F0F4F5] shadow-2xl rounded-2xl overflow-hidden">
      <Link to="/course-details"><button className="py-2.5 rounded mt-5 shad w-full bg-[#1ab69d] flex items-center justify-center gap-2.5 text-white text-[14px] sm:text-[15px] font-bold">Course Details
